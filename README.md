...
[DISCONTINUED]
Note: After a change in leadership and a number of unsuccessful attempts at decoding brainwave data, the project had been modified to use a Position System to interface the Robotic Arm. The updated project is located <a href="https://github.com/kubakrzep9/Robotic-Arm-Interface">here</a>. The interface for the BCI project is complete for it's purposes but discontinued as the Robotic Arm Interface is a completely redesigned interface.  
